...
export function DeleteCVModal({ open, onClose, onDelete, isPending, cvName }: DeleteCVModalProps) {
  ...
  return (
    <ModalWrapper open={open} onClose={onClose} title={t("dialog.deleteTitle")}>
      <div className="space-y-6">
        <p className="text-sm text-zinc-400 leading-relaxed">
          {t("dialog.deleteMessage", { name: cvName })}
        </p>
