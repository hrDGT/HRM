    ...
    >
      ...
      <div className="flex justify-end gap-3 mt-8">
        <button
          onClick={onClose}
          disabled={isLoading}
          className="h-10 px-6 text-xs font-semibold tracking-wider uppercase rounded-full border border-zinc-700 text-zinc-400 hover:text-zinc-200 hover:border-zinc-500 transition-all"
        >
          {t("skillModal.cancel")}
        </button>
        <button
          ...
          disabled={!canConfirm}
          className={cn(
            "h-10 px-6 text-xs font-semibold tracking-wider uppercase rounded-full transition-all flex items-center",
            canConfirm
