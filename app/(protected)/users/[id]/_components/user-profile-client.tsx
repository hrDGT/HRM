...
export function UserProfileClient({
  ...
  const fieldWrapper =
    "relative rounded-lg border border-white/15 bg-[#353535] focus-within:border-white/30 focus-within:ring-1 focus-within:ring-white/20 transition-all";
  const fieldLabel =
    "absolute left-3 -top-2.5 z-10 bg-[#353535] px-1.5 text-[10px] uppercase tracking-wider text-zinc-500";
  const fieldInput =
            ...
            <div className="text-center space-y-1">
              ...
              {employee.memberSince && (
                <p className="text-xs text-zinc-500">
                  A member since {employee.memberSince}
                </p>
              )}
            </div>
            ...
            >
              ...
              <div className={fieldWrapper}>
                ...
                >
                  <SelectTrigger className={fieldInput}>
                    <SelectValue
                      placeholder={c("placeholders.selectPosition")}
                    />
                  </SelectTrigger>
                  <SelectContent className="bg-[#353535] border-white/10 text-zinc-200">
                    {positions.map((p) => (
