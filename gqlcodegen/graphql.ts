...
export type GetUserCVsQuery = { __typename?: 'Query', cvs: Array<{ __typename?: 'Cv', id: string, name: string, education?: string | null, description: string, user?: { __typename?: 'User', id: string, email: string } | null }> };
