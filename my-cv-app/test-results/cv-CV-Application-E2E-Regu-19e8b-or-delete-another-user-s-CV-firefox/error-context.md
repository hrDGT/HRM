...
- Name: cv.spec.ts >> CV Application E2E >> Regular Employee >> cannot edit or delete another user's CV
- Location: e2e/cv.spec.ts:74:9

# Error details

```
Error: page.goto: Protocol error (Page.navigate): Invalid url: "/login"
Call log:
