...
- Name: cv.spec.ts >> CV Application E2E >> Unauthenticated user >> redirects to login when accessing /cvs
- Location: e2e/cv.spec.ts:15:9

# Error details

```
Error: page.goto: Protocol error (Page.navigate): Invalid url: "/cvs"
Call log:
  - navigating to "/cvs", waiting until "load"
